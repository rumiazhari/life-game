...
test('world gameplay adapter applies local economy, vacancies, travel, and education effects without medical wrappers',()=>{
  ...
  assert.equal(parsed.medicalAccessWrapped,false);
  assert.equal(parsed.medicalRiskWrapped,false);
