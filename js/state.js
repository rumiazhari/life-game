...
function newSubject(){
  ...
  S={sex,first:pick(sex==='M'?MALE:FEMALE),last,dob:currentYear(),age:0,alive:true,cause:'',
    ...
    freedom:70,bureauFavor:0,scrutiny:0,detainedUntil:0,permitUntil:0,housingSecurity:60,financialSecurity:55,medicalRecord:false,conditions:[],lastFavorYear:currentYear(),
